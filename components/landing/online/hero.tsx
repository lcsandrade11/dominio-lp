        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="space-y-6 max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] text-[#1a2b4b]">
              ...
              <span className="text-[#335B9B]">completa</span> para sua empresa
              crescer
            </h1>

            <p className="text-lg md:text-xl text-slate-500 leading-normal max-w-xl">
              Tenha um contador dedicado ao seu negócio sem sair do escritório.
              Gestão contábil, fiscal e financeira 100% digital, com atendimento
              consultivo de verdade.
            </p>
