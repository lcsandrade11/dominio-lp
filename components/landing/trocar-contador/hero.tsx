        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="space-y-6 max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] text-[#1a2b4b]">
              Troque de contador{" "}
              <span className="text-[#335B9B]">sem dor de cabeça</span>
            </h1>

            <p className="text-lg md:text-xl text-slate-500 leading-normal max-w-xl">
              Cansado de falta de atenção, erros e atrasos? Fazemos a migração
              completa da sua contabilidade com segurança, sem perda de dados e
              sem burocracia.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <ContactFormDialog
                triggerText="Quero Trocar de Contador!"
