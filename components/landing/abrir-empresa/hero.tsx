        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="space-y-6 max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] text-[#1a2b4b]">
              Abra sua empresa{" "}
              <span className="text-[#335B9B]">sem burocracia</span> e comece a
              faturar
            </h1>

            <p className="text-lg md:text-xl text-slate-500 leading-normal max-w-xl">
              Do CNPJ ao alvará, cuidamos de toda a abertura da sua empresa.
              Escolha o regime tributário certo desde o início e evite dor de
              cabeça no futuro.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <ContactFormDialog
                triggerText="Quero Abrir Minha Empresa!"
