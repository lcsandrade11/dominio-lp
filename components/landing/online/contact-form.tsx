        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">
              Pronto para ter uma contabilidade online de verdade?
            </h2>
            <p className="text-blue-100 text-lg">
              Fale agora com nossa equipe e descubra como simplificar a gestão
              contábil do seu negócio. Atendimento consultivo, 100% digital, de
