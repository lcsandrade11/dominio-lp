        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-blue-100 text-lg">
              Fale agora com nossa equipe e receba uma orientação completa para
              abrir seu CNPJ com o regime tributário certo, sem burocracia e sem
              custos surpresa.
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="Abertura de MEI">Abertura de MEI</option>
                    <option value="Abertura de Microempresa (ME)">
                      Abertura de Microempresa (ME)
                    </option>
                    <option value="Abertura de Empresa (EPP/LTDA)">
                      Abertura de Empresa (EPP/LTDA)
                    </option>
                    <option value="Regularização de Empresa">
                      Regularização de Empresa
                    </option>
                    <option value="Alteração Contratual">
                      Alteração Contratual
                    </option>
                    <option value="Consultoria Tributária">
