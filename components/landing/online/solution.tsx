...
export function Solution() {
  const benefits = [
    "Gestão contábil e fiscal 100% digital",
    "Atendimento consultivo por WhatsApp e videochamada",
    "Relatórios e dashboards em tempo real",
    "Suporte completo para todas as obrigações acessórias",
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Contabilidade digital com{" "}
              <span className="text-[#335B9B]">
                inteligência e atendimento real.
              </span>
            </h2>
            <p className="text-slate-600 text-lg mb-6 leading-normal">
              A Domínio Soluções combina tecnologia de ponta com 20 anos de
              experiência para oferecer uma contabilidade online que vai além do
              básico. Atendimento consultivo, automação fiscal e uma equipe
              dedicada ao seu negócio — de qualquer lugar do Brasil.
            </p>
            ...
            <ContactFormDialog
              triggerText="Quero Contabilidade Online"
