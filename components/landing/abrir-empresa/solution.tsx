...
export function Solution() {
  const benefits = [
    "Abertura rápida de CNPJ e inscrições",
    "Escolha do regime tributário ideal",
    "Alvará e licenças sem complicação",
    "Suporte contábil completo pós-abertura",
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Sua empresa aberta com{" "}
              <span className="text-[#335B9B]">segurança e agilidade.</span>
            </h2>
            <p className="text-slate-600 text-lg mb-6 leading-normal">
              A Domínio Soluções cuida de todo o processo de abertura da sua
              empresa, do planejamento tributário à emissão do alvará. Com 20
              anos de experiência, garantimos que você comece no regime certo e
              sem burocracia.
            </p>
            ...
            <ContactFormDialog
              triggerText="Abrir Minha Empresa"
