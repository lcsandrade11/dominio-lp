        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">
              Pronto para mudar de contador?
            </h2>
            <p className="text-blue-100 text-lg">
              Fale agora com nossa equipe. Nós cuidamos de toda a migração
              contábil da sua empresa — do distrato com o contador atual à
              transferência completa dos seus dados. Sem burocracia e sem
              interrupção.
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="Insatisfação com atendimento">
                      Insatisfação com atendimento
                    </option>
                    <option value="Erros recorrentes na contabilidade">
                      Erros recorrentes na contabilidade
                    </option>
                    <option value="Falta de planejamento tributário">
                      Falta de planejamento tributário
                    </option>
                    <option value="Custos altos do contador atual">
                      Custos altos do contador atual
                    </option>
                    <option value="Migração de escritório contábil">
