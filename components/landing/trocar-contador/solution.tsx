...
export function Solution() {
  const benefits = [
    "Migração completa sem burocracia",
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Migração contábil com{" "}
              <span className="text-[#335B9B]">segurança e tranquilidade.</span>
            </h2>
            <p className="text-slate-600 text-lg mb-6 leading-normal">
              A Domínio Soluções cuida de toda a transição da sua contabilidade.
              Nós conversamos com seu contador atual, transferimos todos os
              dados e assumimos suas obrigações sem interrupção. Com 20 anos de
              experiência, garantimos uma migração sem surpresas.
            </p>
            ...
            <ContactFormDialog
              triggerText="Trocar de Contador Agora"
